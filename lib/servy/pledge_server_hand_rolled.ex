...
defmodule Servy.PledgeServerHandRolled do
  ...
  # This doesn't return the actual total pledged,
  # just the sum of the most recent three pledges
...
# PledgeServerHandRolled.clear_cache()
